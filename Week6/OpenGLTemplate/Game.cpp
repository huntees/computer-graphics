...
void Game::Render() 
{
	...
	pSphereProgram->SetUniform("light1.La", glm::vec3(1.f, 0.f, 1.f));
	pSphereProgram->SetUniform("light1.Ld", glm::vec3(1.f, 0.f, 1.f));
	pSphereProgram->SetUniform("light1.Ls", glm::vec3(1.f, 0.f, 1.f));
	...
	glm::vec4 lightPosition2(50, 100, 50, 1);
	pSphereProgram->SetUniform("light2.position", viewMatrix * lightPosition2); // Light position in eye coordinates
	pSphereProgram->SetUniform("light2.La", glm::vec3(1.f, 1.f, 0.f));
	pSphereProgram->SetUniform("light2.Ld", glm::vec3(1.f, 1.f, 0.f));
	pSphereProgram->SetUniform("light2.Ls", glm::vec3(1.f, 1.f, 0.f));
	...
	for (int i = 0; i < 11; i++) {
		for (int j = 0; j < 11; j++) {
			modelViewMatrixStack.Push();
			modelViewMatrixStack.Translate(glm::vec3(-45.f + (i * 10.f), 5.0f, -50.f + (j * 10.f)));
